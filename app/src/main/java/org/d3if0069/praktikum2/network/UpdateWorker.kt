package org.d3if0069.praktikum2.network
...
import org.d3if0069.praktikum2.MainActivity
    ...
    override suspend fun doWork(): Result {
        ...
        val builder = NotificationCompat.Builder(applicationContext,
            ...
            .setContentText(applicationContext.getString(
                R.string.notif_text))
            .setPriority(NotificationCompat.PRIORITY_HIGH).setContentIntent(getPendingIntent(applicationContext))
            .setAutoCancel(true)
